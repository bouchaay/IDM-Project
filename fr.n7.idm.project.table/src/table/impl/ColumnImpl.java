 ...
 * </p>
 * <ul>
 *   <li>{@link table.impl.ColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link table.impl.ColumnImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	 ...
	 * @ordered
	 */
	protected static final ColumnDataType TYPE_EDEFAULT = ColumnDataType.INTEGER;
	 ...
	 * @ordered
	 */
	protected ColumnDataType type = TYPE_EDEFAULT;
	 ...
	 */
	@Override
	public void setType(ColumnDataType newType) {
		ColumnDataType oldType = type;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TablePackage.COLUMN__NAME:
				...
				return;
			case TablePackage.COLUMN__TYPE:
				setType((ColumnDataType)newValue);
				return;
		}
