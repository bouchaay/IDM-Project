 ...
 *   <li>{@link table.impl.TableImpl#getId <em>Id</em>}</li>
...
public class TableImpl extends MinimalEObjectImpl.Container implements Table {
	...
	public void setId(int newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.TABLE__ID, oldId, id));
	}
	...
	public EList<Column> getColumn() {
		if (column == null) {
			column = new EObjectContainmentEList<Column>(Column.class, this, TablePackage.TABLE__COLUMN);
		}
		return column;
	}
