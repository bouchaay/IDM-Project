...
import fr.n7.idm.project.shemaTableWithAlgorithme.ReferencedColumn;
import fr.n7.idm.project.shemaTableWithAlgorithme.ShemaTable;
import fr.n7.idm.project.shemaTableWithAlgorithme.ShemaTableWithAlgorithmeFactory;
 ...
 * @generated
 */
public class ShemaTableWithAlgorithmePackageImpl extends EPackageImpl implements ShemaTableWithAlgorithmePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.n7.idm.project.shemaTableWithAlgorithme.ShemaTableWithAlgorithmePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ShemaTableWithAlgorithmePackageImpl() {
		super(eNS_URI, ShemaTableWithAlgorithmeFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ShemaTableWithAlgorithmePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ShemaTableWithAlgorithmePackage init() {
		if (isInited)
			return (ShemaTableWithAlgorithmePackage) EPackage.Registry.INSTANCE
					.getEPackage(ShemaTableWithAlgorithmePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredShemaTableWithAlgorithmePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ShemaTableWithAlgorithmePackageImpl theShemaTableWithAlgorithmePackage = registeredShemaTableWithAlgorithmePackage instanceof ShemaTableWithAlgorithmePackageImpl
				? (ShemaTableWithAlgorithmePackageImpl) registeredShemaTableWithAlgorithmePackage
				: new ShemaTableWithAlgorithmePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theShemaTableWithAlgorithmePackage.createPackageContents();

		// Initialize created meta-data
		theShemaTableWithAlgorithmePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theShemaTableWithAlgorithmePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ShemaTableWithAlgorithmePackage.eNS_URI, theShemaTableWithAlgorithmePackage);
		return theShemaTableWithAlgorithmePackage;
	}
	 ...
	 */
	@Override
	public EReference getOutput_AlgoOfOutput() {
	 ...
	 */
	@Override
	public ShemaTableWithAlgorithmeFactory getShemaTableWithAlgorithmeFactory() {
		return (ShemaTableWithAlgorithmeFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(outputEClass, OUTPUT__ALGO_OF_OUTPUT);
	...
	public void initializePackageContents() {
		...
		initEReference(getShemaTable_Catalogue(), this.getCatalogue(), null, "catalogue", null, 1, 1, ShemaTable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getColumn_DataType(), this.getColumnDataType(), "dataType", null, 0, 1, Column.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getColumn_Constraint(), this.getConstraint(), null, "constraint", null, 1, 1, Column.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(derivedColumnEClass, DerivedColumn.class, "DerivedColumn", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDerivedColumn_OutputColumn(), this.getOutput(), null, "outputColumn", null, 1, 1,
				DerivedColumn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(algorithmEClass, Algorithm.class, "Algorithm", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAlgorithm_Input(), this.getInput(), null, "input", null, 1, 1, Algorithm.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getAlgorithm_Output(), this.getOutput(), null, "output", null, 1, 1, Algorithm.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInput_InputColumns(), this.getColumn(), null, "inputColumns", null, 1, -1, Input.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInput_Constante(), this.getConstant(), null, "constante", null, 0, 1, Input.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(outputEClass, Output.class, "Output", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOutput_AlgoOfOutput(), this.getAlgorithm(), null, "AlgoOfOutput", null, 1, 1, Output.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(constantEClass, Constant.class, "Constant", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getConstant_Value(), ecorePackage.getEInt(), "value", null, 0, 1, Constant.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCatalogue_Name(), ecorePackage.getEString(), "name", null, 0, 1, Catalogue.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCatalogue_Algorithms(), this.getAlgorithm(), null, "algorithms", null, 0, -1, Catalogue.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //ShemaTableWithAlgorithmePackageImpl
