 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.idm.project.shemaTableWithAlgorithme.impl.ReferencedColumnImpl#getForeignColumn <em>Foreign Column</em>}</li>
 *   <li>{@link fr.n7.idm.project.shemaTableWithAlgorithme.impl.ReferencedColumnImpl#getForeignTable <em>Foreign Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferencedColumnImpl extends ColumnImpl implements ReferencedColumn {
	...
	protected EClass eStaticClass() {
		return ShemaTableWithAlgorithmePackage.Literals.REFERENCED_COLUMN;
	}
			...
			if (foreignColumn != oldForeignColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ShemaTableWithAlgorithmePackage.REFERENCED_COLUMN__FOREIGN_COLUMN, oldForeignColumn,
							foreignColumn));
			}
		}
	...
	public ShemaTable getForeignTable() {
		if (foreignTable != null && foreignTable.eIsProxy()) {
			...
			if (foreignTable != oldForeignTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ShemaTableWithAlgorithmePackage.REFERENCED_COLUMN__FOREIGN_TABLE, oldForeignTable,
							foreignTable));
			}
		}
		return foreignTable;
	...
	public void setForeignTable(ShemaTable newForeignTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ShemaTableWithAlgorithmePackage.REFERENCED_COLUMN__FOREIGN_TABLE, oldForeignTable, foreignTable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ShemaTableWithAlgorithmePackage.REFERENCED_COLUMN__FOREIGN_COLUMN:
			if (resolve)
				return getForeignColumn();
			return basicGetForeignColumn();
		case ShemaTableWithAlgorithmePackage.REFERENCED_COLUMN__FOREIGN_TABLE:
			if (resolve)
