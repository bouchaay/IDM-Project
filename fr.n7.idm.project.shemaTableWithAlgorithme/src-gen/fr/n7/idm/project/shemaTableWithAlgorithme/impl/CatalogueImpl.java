 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.idm.project.shemaTableWithAlgorithme.impl.CatalogueImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.idm.project.shemaTableWithAlgorithme.impl.CatalogueImpl#getAlgorithms <em>Algorithms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatalogueImpl extends MinimalEObjectImpl.Container implements Catalogue {
	...
	protected EClass eStaticClass() {
		return ShemaTableWithAlgorithmePackage.Literals.CATALOGUE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShemaTableWithAlgorithmePackage.CATALOGUE__NAME,
					oldName, name));
	}
	...
	public EList<Algorithm> getAlgorithms() {
		if (algorithms == null) {
			algorithms = new EObjectResolvingEList<Algorithm>(Algorithm.class, this,
					ShemaTableWithAlgorithmePackage.CATALOGUE__ALGORITHMS);
		}
		return algorithms;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ShemaTableWithAlgorithmePackage.CATALOGUE__NAME:
			return getName();
		case ShemaTableWithAlgorithmePackage.CATALOGUE__ALGORITHMS:
