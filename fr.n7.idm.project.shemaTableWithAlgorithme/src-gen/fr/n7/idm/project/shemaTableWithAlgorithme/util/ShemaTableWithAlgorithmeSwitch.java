 ...
 * @generated
 */
public class ShemaTableWithAlgorithmeSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ShemaTableWithAlgorithmeSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ShemaTableWithAlgorithmePackage.REFERENCED_COLUMN: {
			...
			if (result == null)
				result = caseColumn(referencedColumn);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ShemaTableWithAlgorithmePackage.DERIVED_COLUMN: {
			...
			if (result == null)
				result = caseColumn(derivedColumn);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
...
} //ShemaTableWithAlgorithmeSwitch
