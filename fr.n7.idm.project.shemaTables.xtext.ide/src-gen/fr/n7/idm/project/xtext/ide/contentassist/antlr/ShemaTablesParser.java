 ...
 */
package fr.n7.idm.project.xtext.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import fr.n7.idm.project.xtext.ide.contentassist.antlr.internal.InternalShemaTablesParser;
import fr.n7.idm.project.xtext.services.ShemaTablesGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class ShemaTablesParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ShemaTablesGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ShemaTablesGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTablesAccess().getNameAssignment_1(), "rule__Tables__NameAssignment_1");
			builder.put(grammarAccess.getTablesAccess().getShematablesAssignment_4(), "rule__Tables__ShematablesAssignment_4");
	...
	@Override
	protected InternalShemaTablesParser createParser() {
		InternalShemaTablesParser result = new InternalShemaTablesParser(null);
