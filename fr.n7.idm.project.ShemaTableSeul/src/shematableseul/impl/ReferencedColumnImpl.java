 ...
 * </p>
 * <ul>
 *   <li>{@link shematableseul.impl.ReferencedColumnImpl#getForeignTable <em>Foreign Table</em>}</li>
 *   <li>{@link shematableseul.impl.ReferencedColumnImpl#getForeignColumn <em>Foreign Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferencedColumnImpl extends ColumnImpl implements ReferencedColumn {
	...
	protected EClass eStaticClass() {
		return ShematableseulPackage.Literals.REFERENCED_COLUMN;
	}
		...
		if (foreignTable != null && foreignTable.eIsProxy()) {
			...
			if (foreignTable != oldForeignTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShematableseulPackage.REFERENCED_COLUMN__FOREIGN_TABLE, oldForeignTable, foreignTable));
			}
		}
		return foreignTable;
	}
	...
	public void setForeignTable(ShemaTable newForeignTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShematableseulPackage.REFERENCED_COLUMN__FOREIGN_TABLE, oldForeignTable, foreignTable));
	}
	...
	public Column getForeignColumn() {
		if (foreignColumn != null && foreignColumn.eIsProxy()) {
			...
			if (foreignColumn != oldForeignColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShematableseulPackage.REFERENCED_COLUMN__FOREIGN_COLUMN, oldForeignColumn, foreignColumn));
			}
		}
	...
	public void setForeignColumn(Column newForeignColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShematableseulPackage.REFERENCED_COLUMN__FOREIGN_COLUMN, oldForeignColumn, foreignColumn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ShematableseulPackage.REFERENCED_COLUMN__FOREIGN_TABLE:
				if (resolve) return getForeignTable();
				return basicGetForeignTable();
			case ShematableseulPackage.REFERENCED_COLUMN__FOREIGN_COLUMN:
