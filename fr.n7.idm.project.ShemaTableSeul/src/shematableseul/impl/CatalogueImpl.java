 ...
 * </p>
 * <ul>
 *   <li>{@link shematableseul.impl.CatalogueImpl#getName <em>Name</em>}</li>
 *   <li>{@link shematableseul.impl.CatalogueImpl#getAlgorithms <em>Algorithms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatalogueImpl extends MinimalEObjectImpl.Container implements Catalogue {
	...
	protected EClass eStaticClass() {
		return ShematableseulPackage.Literals.CATALOGUE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShematableseulPackage.CATALOGUE__NAME, oldName, name));
	}
	...
	public EList<Algorithm> getAlgorithms() {
		if (algorithms == null) {
			algorithms = new EObjectContainmentEList<Algorithm>(Algorithm.class, this, ShematableseulPackage.CATALOGUE__ALGORITHMS);
		}
		return algorithms;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ShematableseulPackage.CATALOGUE__ALGORITHMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ShematableseulPackage.CATALOGUE__NAME:
				return getName();
			case ShematableseulPackage.CATALOGUE__ALGORITHMS:
