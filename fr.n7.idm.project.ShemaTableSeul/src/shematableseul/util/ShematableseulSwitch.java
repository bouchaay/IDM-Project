 ...
 * @generated
 */
public class ShematableseulSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ShematableseulPackage.SHEMA_TABLE: {
				ShemaTable shemaTable = (ShemaTable)theEObject;
				T result = caseShemaTable(shemaTable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShematableseulPackage.COLUMN: {
				Column column = (Column)theEObject;
				T result = caseColumn(column);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShematableseulPackage.REFERENCED_COLUMN: {
			...
			case ShematableseulPackage.DERIVED_COLUMN: {
			...
			case ShematableseulPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShematableseulPackage.CATALOGUE: {
				Catalogue catalogue = (Catalogue)theEObject;
				T result = caseCatalogue(catalogue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShematableseulPackage.ALGORITHM: {
				Algorithm algorithm = (Algorithm)theEObject;
				T result = caseAlgorithm(algorithm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShematableseulPackage.INPUT: {
				Input input = (Input)theEObject;
				T result = caseInput(input);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShematableseulPackage.OUTPUT: {
			...
			case ShematableseulPackage.CONSTANT: {
